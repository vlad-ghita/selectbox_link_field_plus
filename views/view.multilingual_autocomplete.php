<?php
	...
	Class SBLPView_Multilingual_Autocomplete extends SBLPView
	{
		...
		public function getName(){
			return __("Multilingual autocomplete");
		}

		public function getHandle(){
			return 'multilingual_autocomplete';
		}
		...
		public function generateView(XMLElement &$wrapper, $fieldname, $options, fieldSelectBox_Link_plus $field){
			...
			$wrapper->appendChild(new XMLElement('input', null, array('type' => 'text', 'class' => 'sblp-multilingual_autocomplete')));

			// Show checkboxes:
			$checkboxes = new XMLElement('div', null, array('class' => 'sblp-multilingual_autocomplete'));
			foreach( $options as $optGroup ){
				...
				if( isset($optGroup['label']) ){
					...
					foreach( $optGroup['options'] as $option ){
						...
						if( $actions !== '' ){
							$label->appendChild(new XMLElement('span', $actions, array('class' => 'sblp-multilingual_autocomplete-actions')));
						}
		...
		public static function appendAssets(){
			if( self::$assets_loaded === false
				...
				$page->addStylesheetToHead(URL."/extensions/selectbox_link_field_plus/assets/styles/view.multilingual_autocomplete.css");
				$page->addScriptToHead(URL."/extensions/selectbox_link_field_plus/assets/libraries/jquery.autocomplete.js");
				$page->addScriptToHead(URL."/extensions/selectbox_link_field_plus/assets/libraries/sblpview_multilingual_autocomplete.js");
				$page->addScriptToHead(URL."/extensions/selectbox_link_field_plus/assets/libraries/view.multilingual_autocomplete.js");
			}
		}
	}
