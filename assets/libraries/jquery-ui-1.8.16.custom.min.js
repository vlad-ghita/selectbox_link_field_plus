...
(function (c, j) {
	...
	if (!c.ui.version) {
		...
		c.extend(c.ui, {plugin: {add: function (a, b, d) {
			...
			a[b] = 0;
			return d
		}, isOverAxis:          function (a, b, d) {return a > b && a < b + d}, isOver: function (a, b, d, e, h, i) {
...
(function (b, j) {
	if (b.cleanData) {
		...
		b.fn.remove = function (a, c) {
			return this.each(function () {
				if (!c)if (!a || b.filter(a, [this]).length)b("*", this).add([this]).each(function () {try {b(this).triggerHandler("remove")} catch (d) {}});
	...
	}, widget:                        function () {return this.element}, option: function (a, c) {
		var d = a;
...
(function (b) {
	...
	b.widget("ui.mouse", {options: {cancel: ":input,option", distance: 1, delay: 0}, _mouseInit: function () {
		var a = this;
		this.element.bind("mousedown." + this.widgetName,function (c) {return a._mouseDown(c)}).bind("click." + this.widgetName, function (c) {
		...
		_getDragVerticalDirection:                          function () {
			...
			if (!d.ui.contains(this.element[0], this.currentItem[0])) {
				...
				for (e = this.containers.length - 1; e >= 0; e--)if (d.ui.contains(this.containers[e].element[0], this.currentItem[0]) && !b) {
					c.push(function (f) {return function (g) {f._trigger("receive", g, this._uiHash(this))}}.call(this, this.containers[e]));
